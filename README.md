...
## Overrides in jez500/docker-mysql-backup

The following is added ontop of `databack/mysql-backup` to better suit restic workflow (which happens independently):

* Post backup script added that removes old backups then renames to be consistent filename so restic
  can handle the snapshots

### Sources
* https://github.com/databacker/mysql-backup
* https://hub.docker.com/r/databack/mysql-backup
* https://github.com/jez500/docker-mysql-backup
* https://hub.docker.com/r/jez500/docker-mysql-backup
